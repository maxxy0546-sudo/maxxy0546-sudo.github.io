...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    // Explicitly define feature flags from process.env so GitHub
    ...
    define: {
      ...
      'import.meta.env.VITE_ENABLE_SIGNAL_PAGE': JSON.stringify(
        process.env.VITE_ENABLE_SIGNAL_PAGE || env.VITE_ENABLE_SIGNAL_PAGE || ''
      ),
    },
    resolve: {
      alias: {
